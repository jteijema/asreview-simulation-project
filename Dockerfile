...
RUN pip install sentence-transformers~=2.2.2 https://github.com/jteijema/asreview-reusable-fe/archive/main.zip https://github.com/jteijema/asreview-XGBoost/archive/main.zip gensim~=4.2.0 tensorflow~=2.9.1
